      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-slate-300 max-w-2xl mx-auto">
            Click to mine digits and earn Philippine Pesos! Every digit counts towards your mining fortune.
          </p>
        </div>
        ...
        <div className="text-center mt-12 text-slate-400">
          <p>Start mining now and watch your Philippine Peso earnings grow!</p>
        </div>
      </div>
    </main>
  );
