...
import { formatPHP, formatPHPCompact, formatDigits } from "@/lib/currency-formatter";
        ...
        <CardContent className="p-6 text-center">
          <div className="space-y-2">
            ...
            <div className={`text-3xl md:text-4xl font-bold text-emerald-100 transition-all duration-150 ${
              ...
              {formatPHPCompact(animatedEarnings)}
            </div>
            <div className="text-sm text-emerald-400">
              {formatPHP(animatedEarnings)}
            </div>
          </div>
        </CardContent>
      </Card>
