...
import { formatPHP, formatDigits, formatRate } from "@/lib/currency-formatter";
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-cyan-300 font-mono">
                {formatPHP(stats.earningsPerMinute)}/min
              </span>
            </div>
            <div className="flex justify-between">
            ...
            {stats.totalDigitsMined > 0 && (
              <div className="flex justify-between">
                ...
                <span className="text-cyan-300 font-mono">
                  {formatPHP(stats.totalEarnings / stats.totalDigitsMined)}
                </span>
              </div>
            )}
          </div>
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-1 text-xs text-slate-400">
            ...
            {stats.totalEarnings < 100 && (
              <div>• {formatPHP(100 - stats.totalEarnings)} until "₱100 Milestone"</div>
            )}
            {stats.totalEarnings < 1000 && stats.totalEarnings >= 100 && (
              <div>• {formatPHP(1000 - stats.totalEarnings)} until "₱1,000 Fortune"</div>
            )}
          </div>
        </div>
